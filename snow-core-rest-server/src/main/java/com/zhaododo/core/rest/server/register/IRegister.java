package com.zhaododo.core.rest.server.register;
...
public interface IRegister {
     ...
     * @param method_metadata 方法上的 {@link ServiceDesc} 注解内容
     */
    void register(String context, String listenAddress, String serviceType, String methodName, String method_path, String controller_path, ServiceDesc method_metadata);
